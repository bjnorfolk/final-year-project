...
The initial imaging processing work conducted in this thesis was tested on experimental data supplied by the Technical University of Berlin's pulse detonation combustion (PDC) facility. The PDC consists of a 685 mm deflagration-to-detonation transition (DDT)
section and 825 mm exhaust tube. The DDT section has a diameter of 40 mm whilst
the exhaust tube has a diameter of 30 mm. Hydrogen and air are fed to the DDT
section. A number of orifice plates are used to initiate DDT. The detonation wave
front is tracked through the exhaust tube using a number of ionisation and pressure
sensors.
Schlieren measurements were undertaken using a Toepler Z-Type schlieren system(20).
Two 8in parabolic mirrors were combined with a high speed LED(21) to
produce images of the exhaust flow. Images were recorded on a Photron SA-Z camera
for converging and diverging nozzles.
...
to with the Shimadzu HPV-1 camera. The Shimadzu has a resolution of 312 x 260 pixels and a frame rate of up to 1 million fps.
